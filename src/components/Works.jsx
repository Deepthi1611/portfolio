      ...
      >
        <div className='relative w-full h-[230px]'>
          ...
          <div className='absolute inset-0 flex justify-end m-3 card-img_hover'>
            {/* inset-0 is a utility class that sets the top, right, bottom, and left properties of an element all to 0. */}
            <div
              onClick={() => window.open(source_code_link, "_blank")}
              className='black-gradient w-10 h-10 rounded-full flex justify-center items-center cursor-pointer gradient-border '
            >
              <img
                src={github}
                alt='source code'
  ...
  return (
    <>
      ...
      <div className='w-full flex'>
        ...
        >
          Following projects showcases my skills and experience of my work. 
